...
- Create Angular project with ng: `ng new mjc.moneyconverter.client --defaults --skip-install --skip-git `.
...
- Create project file (`mjc.moneyconverter.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `mjc.moneyconverter.client.esproj`).
